...
$string['hostearlyaccess'] = 'Host/teacher early access';
$string['hostearlyaccess_desc'] = 'How many minutes before the scheduled start time hosts and teachers can start or join the meeting.';
$string['joinbeforestart'] = 'Early access for participants';
$string['joinbeforestart_help'] = 'How many minutes before the scheduled start time participants can join the meeting. Leave as "Use default" to inherit from category or global settings.';
$string['usedefault'] = 'Use default';
$string['noearlyaccess'] = 'No early access';
...
$string['joinbeforehostenable'] = 'Yes';
$string['anytime'] = 'Anytime (same as teachers)';
...
$string['modulename'] = 'Zoom YT meeting';
$string['modulename_help'] = 'Zoom YT is a video and web conferencing platform that gives authorized users the ability to host online meetings.';
$string['modulenameplural'] = 'Zoom YT Meetings';
...
$string['option_jbh'] = 'Students can join before host';
$string['option_jbh_help'] = "Enabling this option allows students to join the meeting before the teacher/host joins or when the host cannot attend the meeting. The meeting will start when the first participant joins.\n\nThis option is mutually exclusive with the 'Waiting room' option, so selecting one will disable the other.";
...
$string['showjoinbutton'] = 'Show Join button on course page';
$string['showjoinbutton_help'] = 'If enabled, a "Join Now" button will appear in the activity description on the main course page. If the meeting is not yet available to join, a "Meeting not yet available" button will be shown instead.';
$string['showjoinbuttondesc'] = 'Display Join button in course listing';
$string['joinnow'] = 'Join Now';
$string['meetingnotyetavailable'] = 'Meeting not yet available';
...
$string['unavailableteacherearly'] = 'As an instructor, you can start the meeting {$a->mins} minutes before the scheduled start time.';
...
$string['categorysettings'] = 'Zoom YT Category Settings';
$string['categorysettings_inherit'] = 'Settings Inheritance';
$string['categorysettings_connection'] = 'Zoom Account Connection';
$string['categorysettings_defaults'] = 'Default Meeting Settings';
$string['categorysettings_saved'] = 'Category settings saved successfully.';
$string['categorysettings_deleted'] = 'Category settings deleted. This category will now inherit from its parent.';
$string['inherit_from_parent'] = 'Inherit from parent category';
$string['inherit_from_parent_desc'] = 'Use settings from the parent category or global settings.';
$string['inherit_from_parent_help'] = 'When enabled, this category will use the Zoom account settings from its parent category. If no parent has settings configured, the global site settings will be used. Disable this to configure a specific Zoom account for this category.';

// Granular inheritance strings.
$string['inherit_zoom_settings'] = 'Inherit Zoom account settings';
$string['inherit_zoom_settings_desc'] = 'Use Zoom API credentials from parent category or global settings.';
$string['inherit_zoom_settings_help'] = 'When enabled, this category will use the Zoom account credentials (Account ID, Client ID, Client Secret) from its parent category or global settings. Disable this to configure a specific Zoom account for this category.';
$string['inherit_meeting_defaults'] = 'Inherit default meeting settings';
$string['inherit_meeting_defaults_desc'] = 'Use default meeting options from parent category or global settings.';
$string['inherit_meeting_defaults_help'] = 'When enabled, this category will use the default meeting settings (recurring, waiting room, video options, etc.) from its parent category or global settings. Disable this to configure specific defaults for this category.';
$string['inherit_youtube_settings'] = 'Inherit YouTube settings';
$string['inherit_youtube_settings_desc'] = 'Use YouTube channel from parent category or global settings.';
$string['inherit_youtube_settings_help'] = 'When enabled, this category will use the YouTube channel connection from its parent category or global settings. Disable this to connect a specific YouTube channel for this category.';

// YouTube category strings.
$string['youtube_site_credentials_required'] = 'YouTube API credentials must be configured in the global plugin settings before connecting a channel.';
$string['youtube_site_connection'] = 'Site-wide YouTube Channel Connection';
$string['youtube_site_channel_connected'] = 'Connected to YouTube channel: {$a}';
$string['youtube_site_channel_not_connected'] = 'No site-wide YouTube channel connected';
$string['youtube_site_channel_desc'] = 'This YouTube channel will be used as the default for all Zoom YT activities unless overridden at the category or activity level.';
$string['youtube_site_connect_desc'] = 'Connect a YouTube channel to use as the default for uploading Zoom recordings across the entire site.';
$string['youtube_site_default_channel'] = 'Default YouTube Channel';
$string['youtube_site_default_channel_desc'] = 'The default YouTube channel for uploading Zoom recordings site-wide.';
...
$string['using_global_settings'] = 'Currently using global Zoom settings.';
$string['using_own_settings'] = 'This category has its own Zoom account configured.';
$string['inheriting_from_category'] = 'Inheriting settings from category: {$a}';
$string['testconnection'] = 'Test Connection';
$string['deletecategorysettings'] = 'Delete Category Settings';
$string['deletecategorysettings_confirm'] = 'Are you sure you want to delete the category settings? This category will inherit from its parent.';
$string['connectionok'] = 'Connection successful! The Zoom credentials are valid.';
$string['connectionfailed'] = 'Connection failed.';
$string['error_missing_credentials'] = 'Please provide all required credentials (Account ID, Client ID, and Client Secret).';
$string['apiendpoint'] = 'Zoom API endpoint';
...
$string['category_settings_header'] = 'Category-Level Zoom Accounts';
$string['category_settings_header_desc'] = 'Configure different Zoom accounts for different course categories. This allows departments or schools to use their own Zoom accounts.';
$string['manage_category_settings'] = 'Manage Category Zoom Settings';
$string['category_settings_list'] = 'Category Zoom Settings';
$string['category_settings_list_desc'] = 'Configure category-level Zoom account settings. Categories without their own settings will inherit from their parent category, or use global settings if no parent has settings configured.';
...
$string['youtube_client_id_desc'] = 'The OAuth 2.0 Client ID from your Google Cloud Console project. This is used site-wide as the default for YouTube integration.';
...
$string['youtube_client_secret_desc'] = 'The OAuth 2.0 Client Secret from your Google Cloud Console project. This is used site-wide as the default for YouTube integration.';
...
$string['sync_recordings_button'] = 'Check for Zoom Recordings';
$string['sync_youtube_button'] = 'Sync to YouTube';
$string['sync_recordings_success'] = 'Successfully checked for new Zoom cloud recordings.';
$string['sync_recordings_error'] = 'Error checking for recordings: {$a}';
$string['sync_reports_success'] = 'Successfully fetched meeting session data from Zoom.';
...
$string['yt_use_inherited'] = 'Use inherited YouTube channel';
$string['yt_use_inherited_help'] = 'When enabled, recordings from this activity will be uploaded to the YouTube channel configured at the category or site level. Disable this to connect a specific YouTube channel for this activity only.';
$string['youtube_inherited_channel'] = 'Inherited channel';
$string['yt_channel_connected'] = 'Connected: {$a}';
$string['fromcategory'] = 'from category';
$string['fromsite'] = 'from site';
$string['yt_no_channel_configured'] = 'No YouTube channel configured';
$string['yt_activity_channel'] = 'Activity YouTube channel';
$string['yt_activity_channel_not_connected'] = 'No channel connected for this activity';
$string['yt_current_channel'] = 'Current channel';
