...
$string['zoomerr_accountid_missing'] = 'Zoom account ID not found';
...
$string['zoomerr_clientid_missing'] = 'Zoom client ID not found';
$string['zoomerr_clientsecret_missing'] = 'Zoom client secret not found';
