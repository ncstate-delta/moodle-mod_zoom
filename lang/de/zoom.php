...
$string['apiurl_desc'] = '';
$string['attentiveness_score'] = 'Aufmerksamkeitswert*';
$string['attentiveness_score_help'] = '*Der Aufmerksamkeitswert wird gesenkt, wenn ein/eine TeilnehmerIn bei der gemeinsamen Nutzung eines Bildschirms länger als 30 Sekunden keinen Zoom im Fokus hat.';
...
$string['privacy:metadata:zoom_meeting_participants:attentiveness_score'] = 'Die Aufmerksamkeitsbewertung des Teilnehmers';
...
$string['requirepassword'] = 'Meeting-Passwort notwendig';
