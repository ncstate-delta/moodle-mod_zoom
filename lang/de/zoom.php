...
$string['alternative_hosts_help'] = 'Mit der Option "Alternativer Host" können Sie Meetings planen und einen anderen Pro-User auf demselben Konto zum Starten des Meetings oder Webinars bestimmen, falls Sie nicht in der Lage sind. Dieser User erhält eine E-Mail, die ihn darüber informiert, dass er als alternativer Host hinzugefügt wurde, mit einem Link zum Starten des Meetings. Trennen Sie mehrere E-Mails durch Komma (ohne Leerzeichen).';
...
$string['calendariconalt'] = 'Kalendersymbol';
$string['changehost'] = 'Host ändern';
...
$string['err_invalid_password'] = 'Der Passcode beinhaltet ungültige Zeichen.';
$string['err_password'] = 'Der Passcode darf nur die folgenden Zeichen enthalten: [a-z A-Z 0-9 @ - _ *]. Maximal 10 Zeichen.';
$string['err_password_required'] = 'Passcode ist erforderlich.';
$string['err_start_time_past'] = 'Das Startdatum kann nicht in der Vergangenheit liegen.';
$string['errorwebservice_badrequest'] = 'Zoom erhielt "bad request"": {$a}';
...
$string['host'] = 'Host';
$string['invalidscheduleuser'] = 'Sie können für den angegebenen User nicht planen.';
$string['invalid_status'] = 'Status ungültig, bitte die Datenbank untersuchen.';
$string['join'] = 'Beitreten';
$string['joinbeforehost'] = 'Beitritt vor Host aktivieren';
...
$string['maskparticipantdata'] = 'TeilnehmerInnendaten maskieren';
$string['maskparticipantdata_help'] = 'Verhindert, dass TeilnehmerInnendaten in Berichten angezeigt werden (nützlich für Webseiten die TeilnehmerInnendaten maskieren, z. B. für DSGVO).';
...
$string['meetingoptions_help'] = '*Vor dem Host beitreten* ermöglicht es den TeilnehmernInnen, dem Meeting beizutreten, bevor der Host beitritt oder wenn der Host nicht an dem Meeting teilnehmen kann.';
...
$string['option_authenticated_users'] = 'Nur authentifizierte User';
$string['option_host_video'] = 'Video vom Host';
$string['option_jbh'] = 'Beitritt vor Host möglich';
$string['option_mute_upon_entry'] = 'Stummschaltung bei Beitritt';
$string['option_mute_upon_entry_help'] = 'Alle TeilnehmerInnen werden automatisch stumm geschaltet, wenn sie dem Meeting beitreten. Der Host steuert, ob die TeilnehmerInnen die Stummschaltung selbst aufheben können.';
...
$string['option_waiting_room'] = 'Warteraum aktivieren';
$string['participantdatanotavailable'] = 'Details nicht verfügbar';
$string['participantdatanotavailable_help'] = 'TeilnehmerInnendaten sind für diese Zoom-Sitzung nicht verfügbar (z. B. Aufgrund von DSGVO-Auflagen).';
$string['participants'] = 'TeilnehmerInnen';
$string['password'] = 'Passcode';
$string['passwordprotected'] = 'Passcodegeschützt';
...
$string['privacy:metadata:zoom_meeting_participants:name'] = 'Der Name des/der Teilnehmers/Teilnehmerin';
$string['privacy:metadata:zoom_meeting_participants:user_email'] = 'Die E-Mail des/der Teilnehmers/Teilnehmerin';
...
$string['recycleonjoin'] = 'Lizenz beim Beitritt recyceln';
$string['licenseonjoin'] = 'Wählen Sie diese Option, wenn Sie möchten, dass der Host beim Start des Meetings, <i>als auch</i> bei der Erstellung eine Lizenz erhält.';
...
$string['scheduleforself'] = 'Meeting für mich selbst planen';
...
$string['waitingroom'] = 'Warteraum aktiviert';
...
$string['zoomerr_licensesnumber_missing'] = 'Zoom "utmost" Einstellung gefunden, aber "licensesnumber" Einstellung nicht gefunden.';
$string['zoomerr_maxretries'] = 'Anruf wurde {$a->maxretries} Mal versucht, schlug aber fehl: {$a->response}';
...
$string['zoomerr_usernotfound'] = 'Ihr Konto konnte bei Zoom nicht gefunden werden. Wenn Sie Zoom zum ersten Mal verwenden, müssen Sie Ihr Konto aktivieren, indem Sie sich bei Zoom <a href="{$a}" target="_blank">{$a}</a> anmelden. Sobald Sie Ihr Zoom-Konto aktiviert haben, laden Sie diese Seite erneut und fahren Sie mit der Einrichtung Ihres Meetings fort. Andernfalls stellen Sie sicher, dass Ihre E-Mail auf Zoom mit Ihrer E-Mail auf diesem System übereinstimmt.';
