...
class external extends external_api {
     ...
     * This function grabs most of the options to display for users in /mod/zoomyt/view.php
    ...
    public static function get_state($zoomid) {
        ...
        if (!$zoom->recurring) {
            ...
            $status = get_string('recurringmeetinglong', 'mod_zoomyt');
        }
    ...
    public static function grade_item_update($zoomid) {
        ...
        $meetinginfo = zoomyt_load_meeting($params['zoomid'], $context, $usestarturl = false);
