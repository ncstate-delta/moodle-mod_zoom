...
class mobile {
    ...
    public static function mobile_course_view($args) {
        ...
        $cm = get_coursemodule_from_id('zoomyt', $args->cmid);
        ...
        $optionaudio = get_string('audio_' . $zoom->option_audio, 'mod_zoomyt');
        ...
        return [
            'templates' => [
                [
                    'id' => 'main',
                    'html' => $OUTPUT->render_from_template("mod_zoomyt/mobile_view_page_$versionname", $data),
                ],
            ],
            'javascript' => "this.loadMeeting = function(result) { window.open(result.joinurl, '_system'); };",
            // This JS will redirect to a joinurl passed by the mod_zoomyt_grade_item_update WS.
            'otherdata' => '',
            'files' => '',
        ];
    }
