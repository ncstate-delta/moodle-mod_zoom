...
/**
 * Event for when a Zoom meeting is updated.
 *
 * @package    mod_zoomyt
 * @copyright  2026 TUCC
...
/**
 * Records when a Zoom meeting is updated via the API.
 */
class meeting_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_meeting_updated', 'mod_zoomyt');
    }
    ...
    public function get_description() {
        ...
        return "User '{$this->userid}' updated Zoom meeting '{$meetingname}' " .
