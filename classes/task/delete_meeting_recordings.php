...
class delete_meeting_recordings extends scheduled_task {
    ...
    public function get_name() {
        return get_string('deletemeetingrecordings', 'mod_zoomyt');
    }
    ...
    public function execute() {
        ...
        $zoomrecordings = zoomyt_get_meeting_recordings_grouped();
        foreach ($zoomrecordings as $meetinguuid => $recordings) {
            try {
                ...
                foreach ($recordings as $zoomrecordingid => $recording) {
                    ...
                    $DB->delete_records('zoomyt_meeting_recordings', ['zoomrecordingid' => $zoomrecordingid]);
                }
