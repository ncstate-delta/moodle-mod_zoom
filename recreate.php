...
$PAGE->set_url('/mod/zoom_yt/recreate.php', ['id' => $cm->id]);
...
$zoom->host_id = zoom_yt_get_user_id();

$trackingfields = $DB->get_records('zoom_yt_meeting_tracking_fields', ['meeting_id' => $zoom->id]);
...
$response = zoom_yt_webservice()->create_meeting($zoom, $cm->id);
...
redirect(
    ...
    get_string('recreatesuccessful', 'mod_zoom_yt')
);
