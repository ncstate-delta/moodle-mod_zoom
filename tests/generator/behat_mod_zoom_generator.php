...
/**
 * Behat data generator for mod_zoomyt
 *
 * @package mod_zoomyt
 * @copyright 2025 Alan McCoy
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_mod_zoomyt_generator extends behat_generator_base {
    /**
    ...
    protected function get_zoom_id(string $zoomname): int {
        ...
        if (!$id = $DB->get_field('zoomyt', 'id', ['name' => $zoomname])) {
    ...
    protected function get_activity_id(string $activityname): int {
        ...
        $sql = <<<EOF
            SELECT cm.instance
              ...
              JOIN {zoomyt} z ON z.id = cm.instance
