...
/**
 * Behat steps for mod_zoomyt.
 *
 * @package mod_zoomyt
 * @copyright 2025 Alan McCoy
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_mod_zoomyt extends behat_base implements Context {
    /**
     ...
     *
     * @param string $type identifies which type of page this is, e.g. 'mod_zoomyt > View'.
    ...
    protected function resolve_page_instance_url(string $type, string $identifier): moodle_url {
        ...
        switch (strtolower($type)) {
            case 'view':
                return new moodle_url('/mod/zoomyt/view.php', [
    ...
    protected function get_meeting_by_name(string $name): stdClass {
        global $DB;
        return $DB->get_record('zoomyt', ['name' => $name]);
    }
    ...
    protected function get_cm_by_meeting_name(string $name): stdClass {
        ...
        return get_coursemodule_from_instance('zoomyt', $meeting->id, $meeting->course);
    }
}
